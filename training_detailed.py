...
class CowClassifier(pl.LightningModule):
    def __init__(self, num_classes, lr=1e-3):
        ...
        model_path = "/path/to/efficientnet_b0_rwightman-7f5810bc.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-dir', type=str, default="Dataset_Augmented7_split_TRAIN")
